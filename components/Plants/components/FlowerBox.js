    ...
    <View style={styles.phaseBox}>
      ...
      <View style={styles.phaseInput}>
        <Text style={[styles.formText, textStyles]}>
          {translation.plants && translation.plants.addPlant.LightsChanged}
        </Text>
        <TouchableOpacity
          onPress={() => {
        ...
        <DatePicker
          ...
          title={translation.plants && translation.plants.addPlant.LightOut}
      ...
      <View style={styles.phaseInput}>
        ...
        <ModalSelector
          ...
          data={translation.plants && translation.plants.addPlant.mediumData}
          initValue={
            translation.plants &&
