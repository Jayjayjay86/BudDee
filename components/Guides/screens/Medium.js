    ...
    <View style={[styles.container, {backgroundColor: theme.core.background}]}>
      ...
      <ScrollView
        ...
        <Text style={[styles.headerText, textColor]}>
          {translation.guides && translation.guides.medium.HeaderText}
        </Text>
        <GuideButtonBar
        ...
        <GuideImage
          translation={translation}
          icon={icons.buttons.guides.images[10]}
        />

        <TldrDisplay
          translation={translation}
          list={translation.guides.medium.tldr}
          theme={theme}
        />
          ...
          {readMoreOpen && (
            <ScrollView style={styles.scrollView}>
              <Text style={[styles.primary, textColor]}>
                {translation.guides && translation.guides.medium.p1}
              </Text>
              {translation.guides &&
                translation.guides.medium.list.map((item, itemIndex) => (
                  <Text key={itemIndex} style={[styles.primary, textColor]}>
                    {item}
                  </Text>
                ))}
            </ScrollView>
      ...
      <View style={styles.instructionContainer}>
        ...
        <Text style={[styles.next, textColor]}>
          {translation.guides && translation.guides.medium.Next}
        </Text>
      </View>
      <BottomToolBar
        icons={icons}
