    ...
    <View style={[styles.container, {backgroundColor: theme.core.background}]}>
      ...
      <ScrollView
        ...
        <Text style={[styles.headerText, textColor]}>
          {translation.guides && translation.guides.strain.HeaderText}
        </Text>
        <GuideButtonBar
          ...
          icons={icons}
        />
        <GuideImage icon={icons.buttons.guides.images[27]} />

        <TldrDisplay
          translation={translation}
          theme={theme}
          list={translation.guides.strain.tldr}
        />
          ...
          {readMoreOpen && (
            <View>
              <Text style={[styles.primary, textColor]}>
                {translation.guides && translation.guides.strain.p1}
              </Text>
              <Text style={[styles.primary, textColor]}>
                {translation.guides && translation.guides.strain.p2}
              </Text>
              <Text style={[styles.primary, textColor]}>
                {translation.guides && translation.guides.strain.p3}
              </Text>
              <Text style={[styles.primary, textColor]}>
                {translation.guides && translation.guides.strain.p4}
              </Text>
              <Text style={[styles.primary, textColor]}>
                {translation.guides && translation.guides.strain.p5}
              </Text>
            </View>
          )}
        </View>
      ...
      <View style={styles.instructionContainer}>
        ...
        <Text style={[styles.next, textColor]}>
          {translation.guides && translation.guides.strain.Next}
        </Text>
      </View>
      <BottomToolBar
        icons={icons}
