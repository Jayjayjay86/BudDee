    ...
    <View style={[styles.container, {backgroundColor: theme.core.background}]}>
      ...
      <ScrollView
        ...
        <Text style={[styles.headerText, textColor]}>
          {translation.guides && translation.guides.humidity.HeaderText}
        </Text>
        <GuideButtonBar
          ...
          icons={icons}
        />
        <GuideImage icon={icons.buttons.guides.images[36]} />

        <TldrDisplay
          translation={translation}
          list={translation.guides.humidity.tldr}
          theme={theme}
        />
          ...
          {readMoreOpen && (
            <ScrollView style={styles.scrollView}>
              <Text style={[styles.primary, textColor]}>
                {translation.guides && translation.guides.humidity.p1}
              </Text>
              <Text style={[styles.primary, textColor]}>
                {translation.guides && translation.guides.humidity.p2}
              </Text>
              <Text style={[styles.primary, textColor]}>
                {translation.guides && translation.guides.humidity.p3}
              </Text>
              <Text style={[styles.primary, textColor]}>
                {translation.guides && translation.guides.humidity.p4}
              </Text>

              <Text style={[styles.primary, textColor]}>
                {translation.guides && translation.guides.humidity.p5}
              </Text>
              <Text style={[styles.primary, textColor]}>
                {translation.guides && translation.guides.humidity.p6}
              </Text>

              <Text style={[styles.primary, textColor]}>
                {translation.guides && translation.guides.humidity.p7}
              </Text>
              <Text style={[styles.primary, textColor]}>
                {translation.guides && translation.guides.humidity.p8}
              </Text>
            </ScrollView>
          )}
        </View>
      ...
      <View style={styles.instructionContainer}>
        ...
        <Text style={[styles.next, textColor]}>
          {translation.guides && translation.guides.humidity.Next}
        </Text>
      </View>
      <BottomToolBar
        icons={icons}
