    ...
    <View style={[styles.container, {backgroundColor: theme.core.background}]}>
      ...
      <ScrollView
        ...
        <Text style={[styles.headerText, textColor]}>
          {translation.guides && translation.guides.pest.HeaderText}
        </Text>
        <GuideButtonBar
          ...
          icons={icons}
        />
        <GuideImage icon={icons.buttons.guides.images[15]} theme={theme} />
        <TldrDisplay
          translation={translation}
          list={translation.guides.pest.tldr}
          theme={theme}
        />
          ...
          {readMoreOpen && (
            <View>
              <Text style={[styles.primary, textColor]}>
                {translation.guides && translation.guides.pest.p1}
              </Text>
              <Text style={[styles.primary, textColor]}>
                {translation.guides && translation.guides.pest.p2}
              </Text>
              <Text style={[styles.primary, textColor]}>
                {translation.guides && translation.guides.pest.p3}
              </Text>
              <Text style={[styles.primary, textColor]}>
                {translation.guides && translation.guides.pest.p4}
              </Text>
              <Text style={[styles.primary, textColor]}>
                {translation.guides && translation.guides.pest.p5}
              </Text>
              <Text style={[styles.primary, textColor]}>
                {translation.guides && translation.guides.pest.p6}
              </Text>
              <Text style={[styles.primary, textColor]}>
                {translation.guides && translation.guides.pest.p7}
              </Text>
            </View>
          )}
        </View>
      ...
      <View style={styles.instructionContainer}>
        ...
        <Text style={[styles.next, textColor]}>
          {translation.guides && translation.guides.pest.Next}
        </Text>
      </View>
      <BottomToolBar
        icons={icons}
