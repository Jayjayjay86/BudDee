    ...
    <View style={[styles.container, {backgroundColor: theme.core.background}]}>
      ...
      <ScrollView
        ...
        <Text style={[styles.headerText, textColor]}>
          {translation.guides && translation.guides.crops.HeaderText}
        </Text>
        <GuideButtonBar
          ...
          icons={icons}
        />
        <GuideImage icon={icons.buttons.guides.images[34]} />

        <TldrDisplay
          translation={translation}
          list={translation.guides.crops.tldr}
          theme={theme}
        />
          ...
          {readMoreOpen && (
            <View>
              <Text style={[styles.primary, textColor]}>
                {translation.guides && translation.guides.crops.p1}
              </Text>
              <Text style={[styles.primary, textColor]}>
                {translation.guides && translation.guides.crops.p2}
              </Text>
            </View>
          )}
        </View>
      ...
      <View style={styles.instructionContainer}>
        ...
        <Text style={[styles.next, textColor]}>
          {translation.guides && translation.guides.crops.Next}
        </Text>
      </View>
      <BottomToolBar
        icons={icons}
