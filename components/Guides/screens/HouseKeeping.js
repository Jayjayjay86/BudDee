...
const hosekeepingimage = require('../../../assets/images/cleaningsupplies.png');
const HouseKeeping = ({navigation}) => {
  ...
  console.log(translation.guides.housekeeping);
  return (
    <View style={styles.container}>
      <View>
        <Text style={styles.headerText}>
          {translation.guides && translation.guides.housekeeping.HouseKeeping}
        </Text>
      </View>
      <Image style={styles.image} source={hosekeepingimage} />
