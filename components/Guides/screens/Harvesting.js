    ...
    <View style={[styles.container, {backgroundColor: theme.core.background}]}>
      ...
      <ScrollView
        ...
        <Text style={[styles.headerText, textColor]}>
          {translation.guides && translation.guides.harvests.HeaderText}
        </Text>
        <GuideButtonBar
          ...
          icons={icons}
        />
        <GuideImage icon={icons.buttons.guides.images[7]} />
        ...
        <View style={styles.readMoreContainer}>
          ...
          {readMoreOpen && (
            <View>
              {translation.guides &&
                translation.guides.harvests.list.map((item, index) => (
      ...
      <View style={styles.instructionContainer}>
        ...
        <Text style={[styles.next, textColor]}>
          {translation.guides && translation.guides.harvests.Next}
        </Text>
      </View>
      <BottomToolBar
        icons={icons}
