export const spn = {
  core: {
    ...
    locale: {},
    strain: {
      FlowerTime: 'Tiempo de Floración (días):',
      Name: 'Nombre de la Cepa:',
      SeedName: 'Nombre del Banco de Semillas:',
      Available: 'Cepas Disponibles',
      Create: 'Crear Cepa',
    },
  },
  actions: {
    ...
    newAction: {
      ...
      DestroyRoom: 'Destruir Todas las Plantas',
      WaterRoom: 'Regar Habitación',
      MakeNutrient: 'Preparar Solución Nutriente',
      MixSolution: 'Mezclar Solución',
      DefoliateRoom: 'Defoliar Habitación',
      CleanRoom: 'Limpiar Habitación',
      ChangeLightSetting: 'Cambiar Configuración de Luces',
      FlushRoom: 'Enjuagar Habitación',
      Other: 'Otro',
      HarvestRoom: 'Cosechar Habitación',
    },
  },
  calculators: {
    calculators: {
      CalculateCO2: 'Calcular CO2 Necesario',
      EnterRate: "'Ingresar Tarifa.',",
      GrowHeight: 'Altura Desde el Suelo (m)',
      GrowLength: 'Altura del Espacio de Crecimiento (m)',
      GrowWidth: 'Ancho del Espacio de Crecimiento (m)',
      EnterHeight: 'Ingresar Altura.',
      EnterLength: 'Ingresar Longitud.',
      EnterWidth: 'Ingresar Ancho.',
      Calculate: 'Calcular',
      EnterFlowerAmount: 'Ingresar Cantidad de Nutrientes para Floración.',
      EnterNutrientAmount: 'Ingresar Cantidad de Nutrientes para Vegetación.',
      EnterNumber: 'Ingresar Número de Plantas.',
      EnterAge: 'Ingresar Edad de la Planta.',
      EnterWattage: 'Ingresar Potencia (vatios).',
      EnterWeeks: 'Ingresar Semanas en Vegetación.',
      EnterDays: 'Ingresar Días en Floración.',
      HeaderText: 'Calculadoras',
      Co2: 'Calculadora de CO2',
      Final: 'Calculadora de Rendimiento Final',
      Lighting: 'Calculadora de Iluminación',
      Water: 'Calculadora de Uso de Agua',
      Electric: 'Calculadora de Electricidad',
      elec: {
        Watts: 'Vatios:',
      ...
      water: {
        ...
        TimeFlower: 'Tiempo en Floración (Días)',
        PlantAge: 'Edad de la Planta al Comienzo de la Vegetación (Días)',
  ...
  environments: {
    ...
    environments: {
      AmountLiters: 'Cantidad (litros):',
      DateCompleted: 'Fecha completada:',
      SelectEnv: 'Seleccionar Ambiente',
      Environment: 'Ambiente:',
      EnvironmentJournal: 'Diario de Ambiente',
      EnvironmentCreated: 'Ambiente Creado y Actualizado',
      EnvironmentUpdated: 'Ambiente Actualizado',
      EnterName: 'Ingrese un Nombre',
      EnterHeight: 'Ingrese la Altura de la Habitación',
      EnterWidth: 'Ingrese el Ancho de la Habitación',
      EnterLength: 'Ingrese la Longitud de la Habitación',
      EnterHours: 'Ingrese Horas de Luz',
      Delete: 'Eliminar',
      ChooseOption: 'Seleccionar una Opción',
      HoursLight: 'Horas de Luz:',
      Plants: 'Plantas:',
      DeleteEnvironment: '¿Eliminar Ambiente?',
      Batches: 'Lotes:',
      Phase: 'Fase:',
      RecordWork: 'Registrar Trabajo',
      Ph: 'pH:',
      Ec: 'EC:',
      MixNutes: 'Mezclar Nutrientes',
      Amount: 'Cantidad (litros):',
      WaterPlants: 'Regar Plantas',
      Envs: 'Ambientes',
    ...
    env_list: {
      ...
      Vegging: 'Vegetación',
      PlantsLow: 'plantas',
      AddJournal: 'Agregar al Diario',
      Edit: 'Editar',
      LightHours: 'Horas de Luz:',
      Placeholder: "'0 (apagado)'",
    },
  },
  guides: {
    faq: {
      top20faq: [
        ...
        },
        {
          ...
          question:
            '¿Cuál es la mejor mezcla de tierra para cultivar marihuana?',
          answer:
  ...
  home: {
    journal: {
      EnvironmentDeleted: 'Entorno Eliminado',
      PlantsDeleted: 'Plantas Eliminadas',
      BatchDeleted: 'Lote Eliminado',
      Ph: 'pH:',
      Liters: 'Litros',
      Heading: 'Diario',
      Nothing: 'Nada Por Hoy',
    },
    toolbox: {
  ...
  plants: {
    other: {
      ...
      PlantsInto: 'plantas en total.',
      SelectEnvToMove: 'Selecciona un Ambiente para Mover',
      RelocatePlants: 'Reubicar Plantas',
      AmountLiters: 'Cantidad (litros):',
      Ph: 'pH:',
      Ec: 'EC:',
      Ppm: 'PPM:',
      ...
      DeleteBatch: '¿Eliminar lote completo?',

      HarvestedOn: 'Cosechado el:',
      CurrentPhase: 'Fase Actual',
      MovePlants: 'Mover Plantas',
      Journal: 'Diario',
      AddMore: 'Agregar Más Plantas',
      BatchId: 'ID de Lote:',
      Hanging: 'Colgando',
      PotSize: 'Tamaño de Maceta (litros):',
      AgeDays: 'Edad en Días:',
    },
    Plants: 'Plantas',
    ...
    addPlant: {
      ...
      CreatedOn: 'Creado el',
      LightOut: 'Luces encendidas el',
      LightOff: 'Luces apagadas el',
    },
    plants: {
    ...
    plant: {
      ...
      Cancel: 'Cancelar',
      DoYou: '¿Realmente desea eliminar',
      Create: 'Crear Cepa',
    },
  },
  settings: {
    other: {
      Save: 'Guardar',
      DeleteStrains: 'Eliminar Cepas',
      DeleteEnvironments: 'Eliminar Entornos',
      DeletePlants: 'Eliminar Plantas',
      DeleteOptions: 'Eliminar Opciones',
      DeleteJournals: 'Eliminar Diarios',
    },
    moreTools: {
    ...
    settings: {
      Strains: 'Cepas',
      EnvironmentJournals: 'Diarios de Entorno',
      Environments: 'Entornos',
      Options: 'Opciones',
      Journals: 'Diarios',
      Plants: 'Plantas',
      NewStrain: 'Nueva Cepa',
      Delete: 'Eliminar',
      DatabaseCleared: 'Base de Datos Borrada',
      ViewStrains: 'Ver Todas las Cepas',
