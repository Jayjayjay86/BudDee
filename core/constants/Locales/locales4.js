export const hind = {
  core: {
    ...
    loading: {
      disclaimer: {
        DisplayPage: 'पृष्ठ प्रदर्शित किया गया',
        NotOlder: '20 से अधिक नहीं?',
        Request:
          'हम Buddee में आपसे अनुरोध करते हैं कि इस ऐप में निहित जानकारी को देखने के लिए आप अपने क्षेत्र की कानूनी आयु आवश्यकताओं को पूरा करें।',
        DisclaimerText:
          'कृपया पहले पुष्टि करें कि आप वाकई 20 वर्ष से अधिक आयु के हैं और साथ ही आप सहमत हैं,',
        TermsLink: 'उपयोग की शर्तें।',
        AcceptText: 'स्वीकार करें',
        DeclineText: 'अस्वीकार करें',
        DefaultLanguage: 'अंग्रेज़ी',
      },
      loadingIndicator: {Loading: 'लोड हो रहा है'},
    },

    locale: {},
    strain: {
      FlowerTime: 'फूलने का समय (दिन):',
      Name: 'प्रजाति का नाम:',
      SeedName: 'बीज बैंक का नाम:',
      Available: 'उपलब्ध प्रजातियां',
      Create: 'प्रजाति बनाएं',
    },
  },
  actions: {
    plantAmountChoice: [
    ...
    newAction: {
      ...
      HeaderMessage: 'काम रिकॉर्ड करें',
      Water: 'पानी',
      BugReport: 'बग रिपोर्ट',
      Repot: 'पुनः पॉट करें',
      Trim: 'छाँटें',
      Train: 'प्रशिक्षित करें',
      Defoliate: 'पत्तियाँ हटाएँ',
      Flush: 'फ्लश करें',
      Harvest: 'फसल काटें',
      Destroy: 'नष्ट करें',
      ActionLabel: 'सहेजें',
      SelectPlant: 'बैच/पौधा चुनें!',
      SelectAction: 'एक क्रिया चुनें!',
      WaterOptions: 'पानी के विकल्प:',
      placeholder: {
        Description: 'विवरण जोड़ें (वैकल्पिक)',
        Amount: 'मात्रा दर्ज करें (लीटर)',
        Ec: 'Ec दर्ज करें',
        Ph: 'Ph दर्ज करें',
        Time: 'समय दर्ज करें (मिनट)',
      },
      DestroyRoom: 'सभी पौधों को नष्ट करें',
      WaterRoom: 'कमरे को पानी दें',
      MakeNutrient: 'पोषक घोल बनाएं',
      MixSolution: 'घोल मिलाएं',
      DefoliateRoom: 'कमरे की पत्तियाँ हटाएँ',
      CleanRoom: 'कमरा साफ करें',
      ChangeLightSetting: 'प्रकाश सेटिंग बदलें',
      FlushRoom: 'कमरे को फ्लश करें',
      Other: 'अन्य',
      HarvestRoom: 'कमरे की फसल काटें',
    },
  },
  calculators: {
    calculators: {
      CalculateCO2: 'आवश्यक CO2 की गणना करें',
      EnterRate: 'दर दर्ज करें',
      GrowHeight: 'फर्श से ऊंचाई (मीटर)',
      GrowLength: 'विकास क्षेत्र की ऊंचाई (मीटर)',
      GrowWidth: 'विकास क्षेत्र की चौड़ाई (मीटर)',
      EnterHeight: 'एक ऊंचाई दर्ज करें।',
      EnterLength: 'एक लंबाई दर्ज करें।',
      EnterWidth: 'एक चौड़ाई दर्ज करें।',
      Calculate: 'गणना करें',
      EnterFlowerAmount: 'फूल पोषक तत्व की मात्रा दर्ज करें।',
      EnterNutrientAmount: 'सब्जी पोषक तत्व की मात्रा दर्ज करें।',
      EnterNumber: 'पौधों की संख्या दर्ज करें।',
      EnterAge: 'पौधे की आयु दर्ज करें।',
      EnterWattage: 'वाट दर्ज करें।',
      EnterWeeks: 'सप्ताह दर्ज करें।',
      EnterDays: 'फूलने के दिनों को दर्ज करें।',
      HeaderText: 'गणक',
      Co2: 'Co2 गणक',
      Final: 'अंतिम उपज गणक',
      Lighting: 'प्रकाश गणक',
      ...
      water: {
        ...
        TimeFlower: 'फूलने का समय (दिन)',
        PlantAge: 'सब्जी के शुरू में पौधे की आयु (दिन)',
        Number: 'पौधों की संख्या',
        NuteVeg: 'सब्जी में प्रति लीटर पोषक तत्व (मिलीलीटर)',
        NuteFlower: 'फूल में प्रति लीटर पोषक तत्व (मिलीलीटर)',
        Button: 'गणना करें',
  ...
  environments: {
    addEnv: {
      LightData: [
        {
          key: 0,
          label: 'लाइट एमिटिंग डायोड (LED)',
        },
        {
          key: 1,
          label: 'कंपैक्ट फ्लोरोसेंट लाइट (CFL)',
        },
        {
          key: 2,
          label: 'हाई प्रेशर सोडियम (HPS)',
        },
        {
          key: 3,
          label: 'मेटल हेडलाइट',
      ...
      Name: 'नाम दर्ज करें',
      ActionLabel: 'सहेजें',
      RoomMeasurements: 'कक्ष की मापें:',
      OtherDetails: 'अन्य विवरण:',
      Aircon: 'एयरकॉन',
      SealedRoom: 'सील्ड कमरा',
      Dehumidifier: 'डीह्यूमिडीफायर',
      placeholder: {
        Sealed: 'सील्ड कमरा',
        Dehumidifier: 'डीह्यूमिडीफायर',
        Aircon: 'एयरकॉन',
        Resting: 'विश्राम स्थिति (सेल्सियस)',
        Length: 'लंबाई (मीटर)',
        Width: 'चौड़ाई (मीटर)',
        Height: 'ऊंचाई (मीटर)',
        Quantity: 'मात्रा',
        Watts: 'वाट्स',
        NamePlace: 'नाम:',
        Name: 'एक पर्यावरण का नाम दर्ज करें',
        Light: 'एक प्रकार चुनें',
        Hours: 'यहाँ प्रकाश की मात्रा दर्ज करें...',
      },
      Lights: 'प्रकाश:',
    },
    environments: {
      AmountLiters: 'मात्रा (लीटर):',
      DateCompleted: 'पूर्णता तिथि:',
      SelectEnv: 'पर्यावरण चुनें',
      Environment: 'पर्यावरण:',
      EnvironmentJournal: 'पर्यावरण जर्नल',
      EnvironmentCreated: 'पर्यावरण बनाया और अपडेट किया गया',
      EnvironmentUpdated: 'पर्यावरण बनाया और अपडेट किया गया',
      EnterName: 'नाम दर्ज करें',
      EnterHeight: 'कक्ष की ऊंचाई दर्ज करें',
      EnterWidth: 'कक्ष की चौड़ाई दर्ज करें',
      EnterLength: 'कक्ष की लंबाई दर्ज करें',
      EnterHours: 'प्रकाश की घंटों की मात्रा दर्ज करें',
      Delete: 'हटाएं',
      ChooseOption: 'एक विकल्प चुनें',
      HoursLight: 'प्रकाश की घंटे:',
      Plants: 'पौधे:',
      DeleteEnvironment: 'पर्यावरण हटाएं?',
      Batches: 'बैच:',
      Phase: 'चरण:',
      RecordWork: 'काम रिकॉर्ड करें',
      Ph: 'pH:',
      Ec: 'Ec:',
      MixNutes: 'मिक्स न्यूट्स',
      Amount: 'मात्रा (लीटर):',
      WaterPlants: 'पौधे पानी दें',
      Envs: 'पर्यावरण',
      NoEnv: 'ओप्स, कोई पर्यावरण नहीं मिला।',
    ...
    env_list: {
      ...
      Vegging: 'वेजिटेटिंग',
      PlantsLow: 'पौधे',
      AddJournal: 'जर्नल में जोड़ें',
      Edit: 'संपादित करें',
      LightHours: 'प्रकाश की घंटे:',
      Placeholder: "'0 (बंद)'",
    },
  },
  guides: {
  ...
  home: {
    journal: {
      StrainCreated: 'प्रजाति बनाई गई',
      EnvironmentCreated: 'पर्यावरण बनाया गया',
      PlantsWatered: 'पौधों को पानी दिया गया',
      EnvironmentDeleted: 'पर्यावरण हटाया गया',
      PlantsDeleted: 'पौधे हटाए गए',
      BatchDeleted: 'बैच हटाया गया',
      Ph: 'pH:',
      Liters: 'लीटर',
      Heading: 'जर्नल',
      Nothing: 'आज के लिए कुछ नहीं',
    },
    toolbox: {
      HeaderText: 'टूलबॉक्स',
      New: 'नया',
  ...
  plants: {
    other: {
      ...
      Environment: 'पर्यावरण:',
      Amount2: 'मात्रा:',
      DateFinished: 'समाप्ति तिथि:',
      PlantsInto: 'पौधों को।',
      SelectEnvToMove: 'हटाने के लिए एक पर्यावरण चुनें',
      RelocatePlants: 'पौधे स्थानांतरित करें',
      AmountLiters: 'मात्रा (लीटर):',
      Ph: 'pH:',
      Ec: 'EC:',
      Ppm: 'PPM:',
      ...
      DeleteBatch: 'पूरे बैच को हटाएं?',
      HarvestedOn: 'कटाई की गई तारीख:',
      CurrentPhase: 'वर्तमान चरण',
      MovePlants: 'पौधे हटाएं',
      Journal: 'जर्नल',
      AddMore: 'और पौधे जोड़ें',
      BatchId: 'बैच आईडी:',
      Hanging: 'वहनी',
      PotSize: 'गमले का आकार (लीटर):',
      AgeDays: 'आयु दिनों में:',
    },
    Plants: 'पौधे',
    NewAction: 'नया कार्रवाई',
    Vegetating: 'वेजिटेटिंग',
    Flowering: 'फ्लावरिंग',
    PotSize: 'गमले का आकार:',
    create_env: {
      placeholder: {
    ...
    addPlant: {
      ...
      LightOut: 'प्रकाश पर बदलाव',
      LightOff: 'प्रकाश बंद हो गया',
    },
    plants: {
    ...
    plant: {
      ...
      Cancel: 'रद्द करें',
      DoYou: 'क्या आप वाकई हटाना चाहते हैं',
      Create: 'प्रजाति बनाएं',
    },
  },
  settings: {
    other: {
      Save: 'सहेजें',
      DeleteStrains: 'प्रजातियाँ हटाएं',
      DeleteEnvironments: 'पर्यावरण हटाएं',
      DeletePlants: 'पौधे हटाएं',
      DeleteOptions: 'विकल्प हटाएं',
      DeleteJournals: 'जर्नल हटाएं',
    },
    moreTools: {
      ...
      Faq: 'FAQ',
      Library: 'लाइब्रेरी',
      NewStrain: 'नयी प्रजाति',
      Archive: 'संग्रह',
    },
    settings: {
      Strains: 'प्रजातियाँ',
      EnvironmentJournals: 'पर्यावरण जर्नल',
      Environments: 'पर्यावरण',
      Options: 'विकल्प',
      Journals: 'जर्नल',
      Plants: 'पौधे',
      NewStrain: 'नई प्रजाति',
      Delete: 'हटाएं',
      DatabaseCleared: 'डेटाबेस साफ़ हो गया',
      ViewStrains: 'सभी प्रजातियाँ देखें',
